<?php
/**
 * BAU MEMEK — Secure File Manager (single file) — Legacy/PHP-wide compatible
 *
...
function render_login($err=''){
    ...
    <!doctype html><html lang="en" class="dark"><head>
      ...
      <div class="w-full max-w-md card p-6">
        ...
        <p class="text-[12px] text-slate-400 mt-4 text-center">© BAU MEMEK x Secure File Manager</p>
      </div>
    </body></html><?php
}
...
<body class="shell text-slate-100" id="bodyRoot">
  ...
  <footer class="w-full px-6 py-4">
    ...
    <div class="text-xs text-slate-400 flex items-center justify-between">
      <span>© <?php echo $yearNow; ?> BAU MEMEK — Secure File Manager. All rights reserved.</span>
